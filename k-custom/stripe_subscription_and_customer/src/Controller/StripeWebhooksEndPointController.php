...
use Drupal\Core\Logger\LoggerChannelInterface; use Drupal\Core\Site\Settings;
use Drupal\stripe_subscription_and_customer\Event\AccountEvent;
use Drupal\stripe_subscription_and_customer\Event\BalanceEvent;
use Drupal\stripe_subscription_and_customer\Event\BitcoinEvent;
use Drupal\stripe_subscription_and_customer\Event\ChargeEvent;
use Drupal\stripe_subscription_and_customer\Event\CouponEvent;
use Drupal\stripe_subscription_and_customer\Event\CustomerEvent;
use Drupal\stripe_subscription_and_customer\Event\DiscountEvent;
use Drupal\stripe_subscription_and_customer\Event\DisputeEvent;
use Drupal\stripe_subscription_and_customer\Event\ExternalAccountEvent;
use Drupal\stripe_subscription_and_customer\Event\InvoiceEvent;
use Drupal\stripe_subscription_and_customer\Event\InvoiceItemEvent;
use Drupal\stripe_subscription_and_customer\Event\OrderEvent;
use Drupal\stripe_subscription_and_customer\Event\OrderReturnEvent;
use Drupal\stripe_subscription_and_customer\Event\PayoutEvent;
use Drupal\stripe_subscription_and_customer\Event\PlanEvent;
use Drupal\stripe_subscription_and_customer\Event\ProductEvent;
use Drupal\stripe_subscription_and_customer\Event\RecipientEvent;
use Drupal\stripe_subscription_and_customer\Event\RefundEvent;
use Drupal\stripe_subscription_and_customer\Event\CustomerSourceEvent;
use Drupal\stripe_subscription_and_customer\Event\ReviewEvent;
use Drupal\stripe_subscription_and_customer\Event\SkuEvent;
use Drupal\stripe_subscription_and_customer\Event\SourceEvent;
use Drupal\stripe_subscription_and_customer\Event\SourceTransactionEvent;
use Drupal\stripe_subscription_and_customer\Event\SubscriptionEvent;
use Drupal\stripe_subscription_and_customer\Event\TransferEvent;
use Stripe\Stripe;
use Stripe\Webhook;
 ...
 */ class StripeWebhooksEndPointController extends ControllerBase implements ContainerInjectionInterface {
  /**
  ...
  private $settings;
  /**
   * StripeWebhooksEndPointController constructor.
   *
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('logger.factory')->get('stripe_subscription_and_customer'),
  ...
  public function captureNotification(Request $request) {
    try {
      ...
      $api_key = $this->settings->get('stripe_subscription_and_customer_api_key');
      $signing_secret_key = $this->settings->get('stripe_subscription_and_customer_signing_secret_key');

...
<div class="brochures-approval-main">
	<div class="brochures-approval-header">
		<!--<div class="header-first">Pro Brochures</div>-->
		<div class="header-second">Select and approve one brochure from the option below</div>
	</div>
	<div class="brochures-approval-body">
		...
		<div class="brochures-approval-reject">
			...
			<div class="submit-send-for-approval">
				<a href="#" class="submit-approval-link" pdf_section="pro-brochure" listing_nid="<?php print $listing_nid; ?>" id="submit-approval-reject-link">Submit</a>
			</div>
		</div>
	</div>
</div>

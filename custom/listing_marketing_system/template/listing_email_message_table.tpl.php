	...
	<table width= "900" align="center" style="border: 1px solid #bbb; line-height: normal; color: #000;width: 900px; padding: 1px;">
		...
		<tr>
			<td colspan="2" align="center" style="padding-bottom: 20px;">
				<div class="message-add" style="text-align: center; color: #6a6e73; font-size: 14px;">Coldwell Banker Residential Brokerage | 1855 Gateway Boulevard, Suite 750, Concord, CA 94520</div>
			</td>
		</tr>
		<tr>
			<td colspan="2">

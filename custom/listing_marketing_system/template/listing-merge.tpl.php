...
//print "<pre>";print_r($form);exit;
	...
	$document1 = cbone_listing_documents_count($nid1);
	$document2 = cbone_listing_documents_count($nid2);
	$lms_video1 = cbone_listing_video_count($nid1);
	$lms_video2 = cbone_listing_video_count($nid2);
?>
...
<table id="cbone-listing-merege">
	...
	<tr class="listing-row">
		<td class="first">Documents (<?php print $document1; ?>): <span>Note: may create duplicates of existing<span></td>
		<td class="second"><?php print render($form['documents']); ?> <div class="three-arrow">&gt;&gt;&gt;</div></td>
		<td class="third">Documents (<?php print $document2; ?>): </td>
	</tr>
	<tr class="listing-row">
		<td class="first">Video (<?php print $lms_video1; ?>): <span>Note: will replace video on original listing<span></td>
		<td class="second"><?php print render($form['video']); ?> <div class="three-arrow">&gt;&gt;&gt;</div></td>
		<td class="third">Video (<?php print $lms_video2; ?>): </td>
	</tr>
</table>

...
//print "<pre>";print_r($var_name);exit;
	...
	if($listing_node->uid == $user->uid || $user->uid == 1) {
		...
		$my_listing_back = '/office-listings-agent/'.$listing_node->uid;
	}
?>
	...
	<div class="manage-listing-tool-body">
		<div class="listing-tools-body">
			...
			<ul>
				...
				<li>
					<?php if($var_name['agent_uid'] == $user->uid || user_has_role(3, $user) || user_has_role(4, $user) ){ ?>
						<div>
				...
				<li>
					...
					<?php /*if( user_has_role(14, $user) && user_has_role(2, $user) && $roles_count == 2) { ?>
						<div><img src="/sites/all/modules/custom/listing_marketing_system/images/tool-icons/print-go-brochures-disabled.png"></div>
						<div>print and go</div>
					<?php } else { ?>
						<a href="<?php print $print_and_go_link; ?>"><div><img src="/sites/all/modules/custom/listing_marketing_system/images/tool-icons/print-go-brochures.png"></div></a>
						<div>print and go</div>
					<?php }*/ ?>
				</li>
				<li>
				...
				<li>
					<?php /*if( user_has_role(3, $user) || user_has_role(4, $user)) { ?>
					    <a href="<?php print $post_to_circle_link; ?>">
						<div><img src="/sites/all/modules/custom/listing_marketing_system/images/tool-icons/post-to-circle.png">	</div></a>
						<?php } else { ?>

...
namespace Drupal\autocomplete_advanced\Plugin\Field\FieldWidget;
 ...
 *
 * @FieldWidget(
 *   id = "autocomplete_advanced",
 *   label = @Translation("Autocomplete Advanced"),
 *   field_types = {
 *     "entity_reference"
 *   },
 ...
 * )
 */
class AutocompleteAdvancedWidget extends WidgetBase implements ContainerFactoryPluginInterface {
  ...
  public static function defaultSettings() {
    return [
      ...
      'autocomplete_route_name' => 'autocomplete_advanced.autocomplete',
      'size' => 60,
      ...
      'new_terms' => FALSE,
      'no_empty_message' => 'No style tags were found. You may add a new style tag.',
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element += [
      ...
      '#min_length' => isset($settings['min_length']) ? $settings['min_length'] : 2,
    ...
    $element += [
      '#multiple' => $multiple,
      '#autocomplete_advanced_path' => preg_replace('/^[^\\/]+/', '', Url::fromRoute('autocomplete_advanced.autocomplete', $route_parameters, ['absolute' => TRUE])->toString()),
